...
// The AI reply is injected via dangerouslySetInnerHTML, so every HTML
// character must be neutralised BEFORE markdown tags are added — otherwise a
// crafted reply (e.g. via a malicious crew name echoed by a tool) runs as XSS.
